...
export default async function deleteTrack ({ userId, trackId }) {
    if (!userId) {
        throw VError('userId is missing on delete track')
    }

    if (!trackId) {
        throw VError('trackId is missing on delete track')
    }
